...
interface HeaderBalloonSvgTwoProps {
  style?: ViewStyle;
//   ropeAnimation: Animated.Value;
  mainColor?: string;
}

const HeaderBalloonSvgTwo: React.FC<HeaderBalloonSvgTwoProps> = ({ style, mainColor = "#ed4c5c" }) => {
//   const animatedStyle = {
//     transform: [
//       {
...
export default HeaderBalloonSvgTwo;
