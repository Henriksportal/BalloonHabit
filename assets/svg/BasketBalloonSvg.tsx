...
const BasketBalloonSvg: React.FC<BasketBalloonSvgProps> = ({ width = 30, height = 90, color = '#000000' }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 512 512">
      <G>
      <Rect x="247.027" y="398.668" fill={'black'} width="17.946" height="500"  />
        <Path
          fill={color}
          stroke={'black'}
...
export default BasketBalloonSvg;
