...
const RopeBalloonAngelTwo: React.FC<BasketBalloonSvgProps> = ({
  x = 350.027,
  y = 300.668,
  width = 17.946,
  height = 500,
  ...
  return (
    <Svg width={30} height={90} viewBox="0 0 512 512" transform={transform}>
      <G>
      <Rect x={x} y={y} fill={'black'} width={width} height={height}  />
        <Path
          fill={color}
          stroke={'black'}
...
export default RopeBalloonAngelTwo;
